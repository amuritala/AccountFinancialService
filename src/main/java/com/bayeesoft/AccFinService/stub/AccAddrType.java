 ...
 *         <element name="MSGADRESS" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}MsgAddrsType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class AccAddrType {
     ...
     * This is why there is not a {@code set} method for the msgadress property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the msgadress property.
     */
    public List<MsgAddrsType> getMSGADRESS() {
        if (msgadress == null) {
            msgadress = new ArrayList<>();
        }
