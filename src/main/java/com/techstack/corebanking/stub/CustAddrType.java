 ...
 *         <element name="DEFAULTADDR" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}YesNoType" minOccurs="0"/>
 *         <element name="COMMADDR" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}YesNoType" minOccurs="0"/>
 ...
 *         <element name="SENDBYEMAIL" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}YesNoType" minOccurs="0"/>
 *         <element name="ADDHOLDMAIL" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}YesNoType" minOccurs="0"/>
 *         <element name="ANSWERBACK" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         <element name="Msgaddress" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}MsgAddrsType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class CustAddrType {
     ...
     * This is why there is not a {@code set} method for the msgaddress property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the msgaddress property.
     */
    public List<MsgAddrsType> getMsgaddress() {
        if (msgaddress == null) {
            msgaddress = new ArrayList<>();
        }
