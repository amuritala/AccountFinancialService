 ...
 *         <element name="INTSTMTREQ" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}YesNoType" minOccurs="0"/>
 ...
 *                   <element name="ILPRODUCT" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}YesNoType" minOccurs="0"/>
 ...
 *                                       <element name="RATEFLAG" type="{http://fcubs.ofss.com/service/FCUBSAccFinService}YesNoType" minOccurs="0"/>
 *                                     </sequence>
 *                                   </restriction>
 *                                 </complexContent>
 *                               </complexType>
...
public class IntDetailsType {
     ...
     * This is why there is not a {@code set} method for the intprodmap property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the intprodmap property.
     */
    public List<IntDetailsType.Intprodmap> getIntprodmap() {
        if (intprodmap == null) {
            intprodmap = new ArrayList<>();
        }
